...
const defaultOwner = '263779331359';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '+263710777423';  // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER || '263779331359';  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'bR4XSCxT#zsusgHQB_hcGpNwe9yLjgoeRTr-mSKcxqCgxUch5swA';  // put your session id here
